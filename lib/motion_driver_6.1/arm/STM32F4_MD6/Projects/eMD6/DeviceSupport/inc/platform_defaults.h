#ifndef _INV_PLATFORM_DEFAULTS_H_ASDFSD__
#define _INV_PLATFORM_DEFAULTS_H_ASDFSD__

#include "board-st_discovery.h"

// Platform defaults for ST Discovery Board
...
#endif	/* _INV_PLATFORM_DEFAULTS_H_ASDFSD__ */
